...
tok_sep     = '※'
tok_curr    = '‖'
tok_range0  = '<SIM※0.0>' #'𝟘'
tok_range1  = '<SIM※0.1>' #'𝟙'
tok_range2  = '<SIM※0.2>' #'𝟚'
tok_range3  = '<SIM※0.3>' #'𝟛'
tok_range4  = '<SIM※0.4>' #'𝟜'
tok_range5  = '<SIM※0.5>' #'𝟝'
tok_range6  = '<SIM※0.6>' #'𝟞'
tok_range7  = '<SIM※0.7>' #'𝟟'
tok_range8  = '<SIM※0.8>' #'𝟠'
tok_range9  = '<SIM※0.9>' #'𝟡'
tok_range10 = '<SIM※1.0>' #'ⓟ'
